...
✅ Luego, se inicia un proyecto frontend con React usando npx create-react-app.
✅ Finalmente, se crea un formulario en React (básico sin estilos) y lo conectamos al backend mediante fetch, permitiendo enviar datos desde el navegador y recibir la respuesta del servidor FastAPI.
